...
export default function handleUserCollections(req: NextApiRequest, res: NextApiResponse<errorResult | successResult> ) {
  switch (req.method) {
      case 'GET':
...
async function getUserCollections (req: NextApiRequest, res: NextApiResponse<errorResult | successResult>) {
